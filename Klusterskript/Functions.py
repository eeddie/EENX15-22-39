...
def saveSim(filename: str, modules: list, simParams: dict, results: dict = None, log: str = None):
    ...
    # existingModules innehåller bara de moduler som "existerar" d.v.s. inte NoDCCommonModeChokeModule eller NoACommonModeChokeModule som inte har parametrar
    # Dessa ska  inte tas med i parameterlistan.
    existingModules = []
    for module in modules:
        if hasattr(module, "params"): existingModules.append(module)

    simDict = {
        "modules": {module.name: module.params for module in existingModules}, # "modules" är en dict med moduler där modulnamn är key och parameterdicten är value

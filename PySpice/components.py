...
def contTriangleSource(circuit, name, in_node, out_node, frequency, amplitude, offset=0, delta = 0.0001):
    """
...
def contSquareSource(circuit, name, in_node, out_node, frequency, amplitude, offset=0, delta = 0.001):
    """
...
def contStepSource(circuit, name, in_node, out_node, amplitude, delta=0.001):
    """ 
...
def contPWMSource(circuit, name, in_node, out_node, frequency, amplitude, dutyCycle, offset=0, delta = 0.001):
    """
